...
const BrowserWindow = () => {
    ...
    return (
        <div className='h-full w-full flex flex-col bg-[#f5f6f7] text-black'>
            ...
            <div className='flex-1 bg-[url("https://images.unsplash.com/photo-1642355008521-236f1d29d0a8?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] bg-no-repeat bg-cover overflow-hidden'>
                {home ? (
